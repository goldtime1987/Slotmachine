                       ...
                       selector:(SEL)sel
{
	...
	CCMenuItem *menuItem = [CCMenuItemImage itemFromNormalImage:normalImage
							...
							selector:(SEL)sel
{
	...
	CCSprite *normalSprite = [resManager getSpriteWithName:normalName];
	CCSprite *selectSprite = [resManager getSpriteWithName:selectName];
...
{
	id movetozero = [CCScaleTo actionWithDuration:0.1f scale:1.2f * m_fOrginalScale];
	id ease = [CCEaseBackOut actionWithAction:movetozero];
	id movetozero1 = [CCScaleTo actionWithDuration:0.1f scale:1.15f * m_fOrginalScale];
	id ease1 = [CCEaseBackOut actionWithAction:movetozero1];
	id movetozero2 = [CCScaleTo actionWithDuration:0.1f scale:1.2f * m_fOrginalScale];
...
{
	id movetozero = [CCScaleTo actionWithDuration:0.1f scale:1.0f * m_fOrginalScale];
	id ease = [CCEaseBackOut actionWithAction:movetozero];
	id movetozero1 = [CCScaleTo actionWithDuration:0.1f scale:1.05 * m_fOrginalScale];
	id ease1 = [CCEaseBackOut actionWithAction:movetozero1];
	id movetozero2 = [CCScaleTo actionWithDuration:0.1f scale:1.0 * m_fOrginalScale];
	id ease2 = [CCEaseBackOut actionWithAction:movetozero2];
	id movetozero3 = [CCScaleTo actionWithDuration:0.1f scale:1.0f * m_fOrginalScale];
